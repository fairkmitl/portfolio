...
function ProjectCard({ project }: { project: Project }) {
  return (
    <div className="rounded-lg border border-gray-100 bg-white p-6 transition-shadow hover:shadow-sm">
      <div className="flex flex-col gap-1 sm:flex-row sm:items-baseline sm:justify-between">
        <h3 className="text-lg font-semibold text-gray-900">{project.name}</h3>
        {project.period && (
          <span className="text-sm text-gray-400 whitespace-nowrap">{project.period}</span>
        )}
      </div>
