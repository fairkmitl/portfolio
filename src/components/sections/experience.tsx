...
function ExperienceCard({ job }: { job: WorkExperience }) {
  return (
    <div className="relative border-l border-gray-200 pl-8 pb-12 last:pb-0">
      <div className="absolute -left-[5px] top-1 h-2.5 w-2.5 rounded-full border-2 border-gray-300 bg-white" />
